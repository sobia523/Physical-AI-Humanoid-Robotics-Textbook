...
from qdrant_client import models # For Qdrant filter models
        ...
        try:
            ...
            if filters:
                ...
                for key, value in filters.items():
                    # For filtering by source_url, ensure exact match
                    if key == "source_url":
                    ...
                    # For filtering by section, use TextMatch for partial/keyword search
                    elif key == "section":
                        must_conditions.append(
                            models.FieldCondition(
                                key="section",
                        ...
                        logger.warning(f"Unsupported filter key: {key}. Ignoring.")
